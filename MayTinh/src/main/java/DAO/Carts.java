...
public class Carts {
	private static final String SELECT_BY_ID = "select id,ima,name,price,mota from maytinhn3.cart where id =?";
	private static final String SELECT_ALL = "select * from maytinhn3.cart";
	private static final String DELETE = "delete from maytinhn3.cart where id = ?;";
	private static final String UPDATE = "update maytinhn3.cart set ima = ?, name = ?,price= ?, mota = ? where id = ?;";
	private static final String INSERT = "insert into maytinhn3.cart(id,ima,name,price,mota) value (?, ?, ?, ?, ?) ;";
